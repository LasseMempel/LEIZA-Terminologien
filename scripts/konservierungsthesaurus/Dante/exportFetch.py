...
checksumFileLink = "https://api.dante.gbv.de/export/download/archlink_conservationthesaurus/Standardexport/checksums.txt"
vocabularyFileLink = "https://api.dante.gbv.de/export/download/archlink_conservationthesaurus/Standardexport/archlink_conservationthesaurus__Standardexport.turtle.ttl"
...
def readChecksumFile(file):
    with open(file, "r") as f:
        ...
        if ttlColumns[0] == "archlink_conservationthesaurus__Standardexport.turtle.ttlsha256":
