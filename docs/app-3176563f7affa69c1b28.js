/*! For license information please see app-3176563f7affa69c1b28.js.LICENSE.txt */
  ...
  [524],
  {
      ...
      "localhost" !== window.location.hostname
        ...
        : "serviceWorker" in navigator &&
          navigator.serviceWorker
            .register("/LEIZA-Terminologien/sw.js")
            .then(function (e) {
    ...
    6498: function (e, t, n) {
      ...
      var T = (function (e) {
        ...
        P = n(8797),
        j = n(9732)
      const L = new p.N5(E, [], window.pageData)
      ;(0, p.iC)(L), L.setApiRunner(i.N)
      const { render: R, hydrate: M } = (0, j.n)()
      ...
      const I = "gatsby-reload-compilation-hash-match"
      ;(0, i.v)("onClientEntry").then(() => {
                          ...
                          (0, r.A)(
                            {
                              path:
                                ...
                                "/500.html" === n.page.path
                                  ? (0, P.A)(o.pathname, "/LEIZA-Terminologien")
                                  : encodeURI(
        ...
        g &&
          "/LEIZA-Terminologien" + g !==
            y.pathname + (g.includes("?") ? y.search : "") &&
          !(
            L.findMatchPath((0, P.A)(y.pathname, "/LEIZA-Terminologien")) ||
        ...
        p.Zf.loadPage(y.pathname + y.search).then((e) => {
          ...
          if (
            ...
            if (!("1" === n.getItem(I)))
              return n.setItem(I, "1"), void window.location.reload(!0)
          }
          if ((n && n.removeItem(I), !e || e.status === p.Wi.Error)) {
    ...
    6814: function (e, t, n) {
      ...
      const p = { Error: "error", Success: "success" },
        f = (e) => {
          const [t, n] = e.split("?")
          var r
          return `/LEIZA-Terminologien/page-data/${
            "/" === t
              ? "index"
      ...
      let b = (function () {
        ...
        return (
          ...
          (t.loadSliceDataJson = function (e) {
            ...
            return h(`/LEIZA-Terminologien/slice-data/${e}.json`, "GET").then(
              (t) => {
                    ...
                    w = Promise.all(
                      h.map((e) => {
                        ...
                        return this.memoizedGet(
                          `/LEIZA-Terminologien/page-data/sq/d/${e}.json`
                        )
                          .then((t) => {
                            const n = JSON.parse(t.responseText)
                          ...
                          .catch(() => {
                            throw new Error(
                              `We couldn't load "/LEIZA-Terminologien/page-data/sq/d/${e}.json"`
                            )
                          })
                      })
                    ).then((e) => {
          ...
          (t.loadAppData = function (e) {
            return (
              void 0 === e && (e = 0),
              this.memoizedGet(
                "/LEIZA-Terminologien/page-data/app-data.json"
              ).then((t) => {
      ...
      const v = (e) =>
        (window.___chunkMapping[e] || []).map((e) => "/LEIZA-Terminologien" + e)
      let w,
        x = (function (e) {
          function t(t, n, r) {
            var o
    ...
    7078: function (e, t, n) {
      ...
      const l = /^[a-zA-Z][a-zA-Z\d+\-.]*?:/,
        ...
        p = () => "/LEIZA-Terminologien",
        f = () => "/LEIZA-Terminologien"
      function d(e, t = p()) {
        var n
        if (!u(e)) return e
      ...
      function A(e) {
        ...
        i.useEffect(() => {
          Promise.resolve().then(() => {
            const o = j(t, a)
            y(L(o, e), { replace: n, state: r })
          })
        }, [])
        const s = j(t, a)
        return o || _(L(s, e)), null
      }
      const E = (e) => {
        const t = k(),
          { baseuri: n } = x()
      ...
      const O = (e, t) => e.substr(0, t.length) === t,
        ...
        U = (e) => (t) => {
          ...
          if (
            ...
            l()(
              !(t.type === E && !R(t.props.from, t.props.to)),
    ...
    8852: function (e, t, n) {
      ...
      function R(e) {
        return l(T(w - 1, N(91 === e ? e + 2 : 40 === e ? e + 1 : e)))
      }
      function M(e) {
        for (; (x = E()) && x < 33; ) A()
        return P(e) > 2 || P(x) > 3 ? "" : " "
      ...
      function G(e) {
        return L(J("", null, null, null, [""], (e = j(e)), 0, [0], e))
      }
            ...
            case 0:
              switch (C) {
                ...
                default:
                  if (
                    (m(
                      (L = K(N, t, n, d, g, o, c, T, (P = []), (j = []), y)),
                      i
                    ),
                    123 === C)
                  )
                    if (0 === g) J(N, t, L, L, P, i, y, c, j)
                    else
                      switch (99 === b && 110 === f(N, 3) ? 100 : b) {
                        case 100:
                        case 108:
                        case 109:
                        case 115:
    ...
    8895: function (e, t, n) {
      ...
      function D(e) {
        ...
        ;(this.tree = []),
          (this.field = []),
          (this.marker = []),
          (this.register = (0, L.fp)()),
          (this.key = ((n = t.key || t.id) && Y(n, this.marker)) || "id"),
          (this.fastupdate = (0, L.uM)(e.fastupdate, !0)),
          T.AO &&
            ((this.storetree = (n = t.store) && !0 !== n && []),
            (this.store = n && (0, L.fp)())),
          T.c9 &&
            ((this.tag = (n = t.tag) && Y(n, this.marker)),
            (this.tagindex = n && (0, L.fp)())),
          T.x8 && ((this.cache = (n = e.cache) && new j.A(n)), (e.cache = !1)),
          T.HE && (this.worker = e.worker),
          T.Bt && (this.async = !1),
      ...
      function H(e, t) {
        ...
        for (let o, i, a = 0; a < r.length; a++)
          (o = r[a]),
            (0, L.PM)(o) || ((i = o), (o = o.field)),
            (i = (0, L.vZ)(i) ? Object.assign({}, e, i) : e),
            T.HE &&
              this.worker &&
              ((n[o] = new N.A(i)), !n[o].worker && (this.worker = !1)),
            this.worker || (n[o] = new P.A(i, this.register)),
            (this.tree[a] = Y(o, this.marker)),
            (this.field[a] = o)
        if (T.AO && this.storetree) {
          let e = t.store
          ;(0, L.PM)(e) && (e = [e])
      ...
      function q(e, t, n, r, o) {
        if (((e = e[o]), r === n.length - 1)) t[o] = e
          ...
          if ((0, L.PI)(e)) {
            ...
            (t = t[o] || (t[o] = (0, L.fp)())), (o = n[++r]), q(e, t, n, r, o)
      }
      ...
      ;(D.prototype.add = function (e, t, n) {
        if (((0, L.vZ)(e) && (e = F((t = e), this.key)), t && (e || 0 === e))) {
          ...
          if (T.AO && this.store && (!n || !this.store[e])) {
            let n
            if (this.storetree) {
              n = (0, L.fp)()
              for (let e, r = 0; r < this.storetree.length; r++)
                (e = this.storetree[r]),
                  (0, L.PM)(e) ? (n[e] = t[e]) : q(t, n, e, 0, e[0])
            }
            this.store[e] = n || t
          }
        }
        ...
        (D.prototype.remove = function (e) {
          if (((0, L.vZ)(e) && (e = F(e, this.key)), this.register[e])) {
            for (
              let t = 0;
              t < this.field.length &&
            ...
            if (T.c9 && this.tag && !this.fastupdate)
            ...
            T.AO && this.store && delete this.store[e], delete this.register[e]
          }
          return this
        }),
        ...
        T.x8 && (D.prototype.searchCache = j.p),
        T.FE && ((D.prototype.export = I.UE), (D.prototype.import = I.b9)),
        T.Bt && (0, R.A)(D.prototype)
      var B = (e) => {
        var t, n, o
        ...
        const { data: v, updateState: w } = (0, u.t)(),
          ...
          { 0: T, 1: P } = (0, r.useState)(null),
          { 0: j, 1: L } = (0, r.useState)(
            "ConceptScheme" === p.node.type ? p.node : null
          )
        let R = !1
        const { 0: M, 1: I } = (0, r.useState)(
          Object.fromEntries(
        ...
        if (
          ...
          for (const r of j.hasTopConcept) {
            var N
            if (
              (null === (N = r.narrower) || void 0 === N ? void 0 : N.length) >
              0
            ) {
              R = !0
              break
        ...
        return (0, s.Y)(
          ...
          (0, s.Y)(
            ...
            (0, s.Y)(
              ...
              (0, s.Y)(A, {
                handleQueryInput: (e) => P(e.target.value || null),
                labels: M,
                onLabelClick: (e) => ((e) => I({ ...M, [e]: !M[e] }))(e),
              }),
              R && (0, s.Y)(m, null),
              (0, s.Y)(
                "div",
                ...
                j &&
                  (0, s.Y)(d, {
                    ...
                    current: p.node.id,
                    queryFilter:
                      T && null != C && C.search ? C.search(T) : null,
                    highlight: T ? RegExp(i()(T), "gi") : null,
                    language: D,
                    topLevel: !0,
    ...
    8990: function (e, t, n) {
      ...
      const l = (e) => {
        ...
        return (0, o.A)(n, decodeURIComponent("/LEIZA-Terminologien")).split(
          "#"
        )[0]
      }
      function u(e) {
    ...
    9243: function (e, t, n) {
      ...
      var j = {
        YAML: function (e, t, n) {
          var r, o, i
          null !== e.version && T(e, "duplication of %YAML directive"),
            1 !== n.length &&
              T(e, "YAML directive accepts exactly one argument"),
            null === (r = /^([0-9]+)\.([0-9]+)$/.exec(n[0])) &&
              T(e, "ill-formed argument of the YAML directive"),
            (o = parseInt(r[1], 10)),
            (i = parseInt(r[2], 10)),
            1 !== o && T(e, "unacceptable YAML version of the document"),
            (e.version = n[0]),
        ...
        TAG: function (e, t, n) {
          var r, o
          2 !== n.length && T(e, "TAG directive accepts exactly two arguments"),
            (r = n[0]),
            (o = n[1]),
            p.test(r) ||
              T(
        ...
        if (t < n) {
          if (((s = e.input.slice(t, n)), r))
            for (o = 0, i = s.length; o < i; o += 1)
              9 === (a = s.charCodeAt(o)) ||
                (32 <= a && a <= 1114111) ||
                T(e, "expected valid JSON character")
          else c.test(s) && T(e, "the stream contains non-printable characters")
          e.result += s
        }
      }
      function R(e, t, n, o) {
      ...
      function M(e, t, n, r, o, i, a, c, l) {
        ...
        if (Array.isArray(o))
          for (
            ...
            Array.isArray(o[u]) &&
              T(e, "nested arrays are not supported inside keys"),
              "object" == typeof o &&
                "[object Object]" === d(o[u]) &&
                (o[u] = "[object Object]")
        if (
          ...
          if (Array.isArray(i))
            for (u = 0, p = i.length; u < p; u += 1) R(e, t, i[u], n)
          else R(e, t, i, n)
        else
          e.json ||
            s.call(n, o) ||
      ...
      function N(e, t, n) {
        for (var r = 0, o = e.input.charCodeAt(e.position); 0 !== o; ) {
          ...
          if (!h(o)) break
          for (
            I(e), o = e.input.charCodeAt(e.position), r++, e.lineIndent = 0;
            32 === o;
      ...
      function H(e, t) {
        ...
        for (
          ...
          (-1 !== e.firstTabInLine &&
            ...
            T(e, "tab characters must not be used in indentation")),
          45 === r) &&
          m(e.input.charCodeAt(e.position + 1));

        )
          if (((s = !0), e.position++, N(e, !0, -1) && e.lineIndent <= t))
      ...
      function Y(e) {
        ...
        if (
          (null !== e.tag && T(e, "duplication of a tag property"),
            ...
            33 === o &&
              (a
                ...
                : ((n = e.input.slice(t - 1, e.position + 1)),
                  p.test(n) ||
                    T(e, "named tag handle cannot contain such characters"),
                  (a = !0),
                  (t = e.position + 1))),
              (o = e.input.charCodeAt(++e.position))
          ;(r = e.input.slice(t, e.position)),
            u.test(r) &&
              T(e, "tag suffix cannot contain flow indicator characters")
        }
        r && !f.test(r) && T(e, "tag name cannot contain such characters: " + r)
        try {
      ...
      function F(e) {
        ...
        for (
          null !== e.anchor && T(e, "duplication of an anchor property"),
        ...
        return (
          e.position === t &&
            T(e, "name of an anchor node must contain at least one character"),
              ...
              ? (l &&
                ...
                (function (e, t) {
                  ...
                  for (
                    ...
                    if (
                      (N(e, !0, t), (d = e.input.charCodeAt(e.position)) === a)
                    )
                      return (
                        e.position++,
                        (e.tag = g),
                    ...
                    h
                      ? 44 === d &&
                        T(e, "expected the node content, but found ','")
                      : T(e, "missed comma between flow collection entries"),
                      (f = null),
                      (s = c = !1),
                      63 === d &&
                        m(e.input.charCodeAt(e.position + 1)) &&
                        ((s = c = !0), e.position++, N(e, !0, t)),
                      (n = e.line),
                      (r = e.lineStart),
                      (o = e.position),
                      q(e, t, 1, !1, !0),
                    ...
                    (function (e, t) {
                      ...
                      for (e.kind = "scalar", e.result = ""; 0 !== a; )
                        if (
                          ...
                          1 === s
                            ? (s = 43 === a ? 3 : 2)
                            : T(e, "repeat of a chomping mode identifier")
                        else {
                          if (!((i = w(a)) >= 0)) break
                          0 === i
                            ? T(
                        ...
                        if (
                          ...
                          for (o = a, i = 0; o > 0; o--)
                            (a = b((s = e.input.charCodeAt(++e.position)))) >= 0
                              ? (i = (i << 4) + a)
                              : T(e, "expected hexadecimal character")
      ...
      function W(e) {
        ...
        for (
          ...
          0 !== o && I(e),
            s.call(j, n)
              ? j[n](e, n, r)
              : P(e, 'unknown document directive "' + n + '"')
        }
        N(e, !0, -1),
          0 === e.lineIndent &&
          ...
          45 === e.input.charCodeAt(e.position + 2)
            ? ((e.position += 3), N(e, !0, -1))
            : a && T(e, "directives end mark is expected"),
      ...
      function U(e, t) {
        ...
        for (
          -1 !== r &&
            ((n.position = r), T(n, "null byte is not allowed in input")),
            n.input += "\0";
...
//# sourceMappingURL=app-3176563f7affa69c1b28.js.map
